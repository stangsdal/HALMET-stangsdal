...
const gpio_num_t kClipperHTDataPin = GPIO_NUM_13;
const gpio_num_t kClipperHTDataOutPin = GPIO_NUM_14;
const gpio_num_t kClipperHTClkPin = GPIO_NUM_32;
const gpio_num_t kClipperHTCSPin = GPIO_NUM_33;
